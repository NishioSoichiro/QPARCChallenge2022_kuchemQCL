...
hoo = read_FCIDUMP("./BAGEL_data/FCIDUMP.CoOPh4_rel")
...
def cost(theta_list):
    ...
    return 2*get_exp(state0, theta_list)+1*get_exp(state1, theta_list)
...
for i_sample in range(3):
    ...
    print('BAGEL\n'      
        ...
        +'22   2  *   -2612.79803069\n'
        +'22   3  *   -2612.79803069\n')
    np.savetxt(f'./output/ssVQE_CoOPh4_rel_sample{i_sample}.csv', data, delimiter=",")
